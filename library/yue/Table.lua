...
---@class Table : View
---@field onselectionchange fun(self: Table): nil Emitted when the table's selection has changed.
---@field onrowactivate fun(self: Table, row: integer): nil Emitted when the user double-clicks a row.
---@field ontogglecheckbox fun(self: Table, column: integer, row: integer): nil Emitted when the user clicks a cell to toggle checkbox.
local Table = {}
--[[Create a new `Table`.]]
---@return Table 
